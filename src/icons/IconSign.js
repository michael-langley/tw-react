...
function SvgIconSign(props) {
  return (
    <svg viewBox="0 0 24 24" className="icon-sign_svg__icon-sign" {...props}>
      <path
        className="icon-sign_svg__primary"
        d="M14 12h5l3 3-3 3h-5v4h-4v-4H4a1 1 0 01-1-1v-4a1 1 0 011-1h6v-1h4v1z"
      />
      <path
        className="icon-sign_svg__secondary"
